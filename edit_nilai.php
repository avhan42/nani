...
$query  = "SELECT * FROM nilai a INNER JOIN kriteria b INNER JOIN guru c INNER JOIN sub_kriteria d WHERE  a.id_kriteria=b.id_kriteria AND a.id_guru=c.id_guru AND a.id_subkriteria=d.id_subkriteria AND id_nilai=$id";
            ...
            <div class="card-body">
              ...
              <form action="fnilai.php" method="post">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="subkriteria" class="form-control" value="<?= $row['nama_subkriteria']; ?>">
                  </div>
                </div>
                <div class="row mb-3">
